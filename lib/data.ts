...
export const partners: Partner[] = [
  ...
  },
  {
    ...
    logo: '/partners/glow-research.png',
  ...
  },
  {
    ...
    logo: '/partners/seoul-skin-science.png',
...
export const categories: Category[] = [
  {
    ...
    productCount: 156,
    subcategories: [
      { id: 'cat-cleansers', slug: 'cleansers', name: 'Cleansers', description: 'Gentle yet effective cleansing', image: '/categories/cleansers.jpg', productCount: 24 },
      { id: 'cat-toners', slug: 'toners', name: 'Toners', description: 'Prep and balance your skin', image: '/categories/toners.jpg', productCount: 18 },
      { id: 'cat-serums', slug: 'serums', name: 'Serums', description: 'Concentrated active treatments', image: '/categories/serums.jpg', productCount: 32 },
      { id: 'cat-moisturizers', slug: 'moisturizers', name: 'Moisturizers', description: 'Deep hydration and nourishment', image: '/categories/moisturizers.jpg', productCount: 28 },
      { id: 'cat-suncare', slug: 'sun-care', name: 'Sun Care', description: 'Advanced UV protection', image: '/categories/suncare.jpg', productCount: 16 },
      { id: 'cat-masks', slug: 'masks', name: 'Masks', description: 'Weekly treatment rituals', image: '/categories/masks.jpg', productCount: 38 },
    ],
  },
  {
    id: 'cat-makeup',
    ...
    productCount: 89,
    subcategories: [
      { id: 'cat-base', slug: 'base', name: 'Base Makeup', description: 'Flawless skin foundation', image: '/categories/base.jpg', productCount: 22 },
      { id: 'cat-lips', slug: 'lips', name: 'Lips', description: 'Vibrant colors and care', image: '/categories/lips.jpg', productCount: 34 },
      { id: 'cat-eyes', slug: 'eyes', name: 'Eyes', description: 'Define and enhance', image: '/categories/eyes.jpg', productCount: 28 },
      { id: 'cat-cheeks', slug: 'cheeks', name: 'Cheeks', description: 'Natural flush and glow', image: '/categories/cheeks.jpg', productCount: 15 },
    ],
  },
  {
    id: 'cat-sets',
...
export const products: Product[] = [
  {
    ...
    images: [
      ...
      { id: 'img-1-2', src: '/products/luminous-glow-serum-2.jpg', alt: 'Luminous Glow Serum texture' },
      { id: 'img-1-3', src: '/products/luminous-glow-serum-3.jpg', alt: 'Luminous Glow Serum application' },
    ],
    category: 'skincare',
    subcategory: 'serums',
  ...
  },
  {
    ...
    currency: 'EUR',
    images: [
      { id: 'img-2-1', src: '/products/hydra-cloud-cream-1.jpg', alt: 'Hydra Cloud Cream jar', isMain: true },
      { id: 'img-2-2', src: '/products/hydra-cloud-cream-2.jpg', alt: 'Hydra Cloud Cream texture' },
    ],
    category: 'skincare',
  ...
  },
  {
    ...
    currency: 'EUR',
    images: [
      { id: 'img-3-1', src: '/products/gentle-foam-cleanser-1.jpg', alt: 'Gentle Cloud Foam Cleanser', isMain: true },
    ],
    category: 'skincare',
  ...
  },
  {
    ...
    currency: 'EUR',
    images: [
      { id: 'img-4-1', src: '/products/tone-up-sun-cream-1.jpg', alt: 'Aura Tone-Up Sun Cream', isMain: true },
      { id: 'img-4-2', src: '/products/tone-up-sun-cream-2.jpg', alt: 'Aura Tone-Up Sun Cream swatch' },
    ],
    category: 'skincare',
  ...
  },
  {
    ...
    currency: 'EUR',
    images: [
      { id: 'img-5-1', src: '/products/velvet-lip-tint-1.jpg', alt: 'Velvet Matte Lip Tint', isMain: true },
    ],
    category: 'makeup',
    subcategory: 'lips',
  ...
  },
  {
    ...
    currency: 'EUR',
    images: [
      { id: 'img-6-1', src: '/products/cica-repair-ampoule-1.jpg', alt: 'Cica Repair Ampoule', isMain: true },
    ],
    category: 'skincare',
    subcategory: 'serums',
  ...
  },
  {
    ...
    currency: 'EUR',
    images: [
      { id: 'img-8-1', src: '/products/pore-refining-serum-1.jpg', alt: 'Pore Refining Serum', isMain: true },
    ],
    category: 'skincare',
    subcategory: 'serums',
...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    customerId: 'cust-3',
    customerName: 'Emma L.',
    customerAvatar: '/avatars/emma.jpg',
    rating: 5,
...
export const testimonials: Testimonial[] = [
  {
    ...
    customerAvatar: '/testimonials/sophie.jpg',
  ...
  },
  {
    ...
    customerAvatar: '/testimonials/marie.jpg',
  ...
  },
  {
    ...
    customerAvatar: '/testimonials/aisha.jpg',
  ...
  },
  {
    ...
    customerAvatar: '/testimonials/elena.jpg',
