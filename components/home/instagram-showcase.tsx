...
import { CheckCircle2, Clapperboard, Copy, Heart, Instagram, MessageCircle } from 'lucide-react'
...
const exampleFeed = [
  {
    ...
    caption: 'Rose-light layering ritual.',
    likes: '1,842',
    comments: '48',
  ...
  },
  {
    ...
    caption: 'Soft cream texture focus.',
    likes: '2,106',
    comments: '61',
    type: 'reel' as const,
  },
  {
    ...
    caption: 'Studio Seoul signature edit.',
    likes: '1,507',
    comments: '33',
    type: 'carousel' as const,
  },
  {
    ...
    caption: 'Hydration with editorial finish.',
    likes: '1,928',
    comments: '54',
    type: 'reel' as const,
  },
  {
    ...
    caption: 'AM SPF with cloud-light skin.',
    likes: '1,673',
    comments: '39',
    type: 'carousel' as const,
  },
  {
    ...
    caption: 'Dropper precision and glow.',
    likes: '2,241',
    comments: '72',
    type: 'reel' as const,
  },
  {
    ...
    caption: 'Night barrier support routine.',
    likes: '1,492',
    comments: '30',
    type: 'carousel' as const,
  },
  {
    ...
    caption: 'JISOO cream ritual moment.',
    likes: '2,011',
    comments: '58',
    type: 'reel' as const,
  },
        ...
        <div className="mb-4 flex items-start justify-between gap-4 border-b border-[#eee1d8] pb-4">
          <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="flex min-w-0 items-center gap-3">
            <div className="relative h-14 w-14 overflow-hidden rounded-full ring-2 ring-rose-mauve/40 ring-offset-2 ring-offset-white">
              <Image src="/hero7/Untitled design (32).png" alt="JISOO Cosmetics profile" fill className="object-cover" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                <h3 className="truncate text-lg font-semibold text-charcoal">JISOO Cosmetics</h3>
                <CheckCircle2 className="h-4 w-4 fill-[#3897f0] text-white" />
              </div>
              <p className="text-sm text-charcoal/60">@jisoocosmetics</p>
            </div>
          </a>
