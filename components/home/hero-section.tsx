    ...
    <section className="grid min-h-[68vh] grid-cols-2 gap-3 rounded-[2rem] bg-[#fffaf6] p-3 lg:grid-cols-12 lg:grid-rows-6 lg:gap-4 lg:p-4">
      ...
      <div className="col-span-2 flex items-center rounded-[1.8rem] border border-rose-mauve/22 bg-[linear-gradient(135deg,rgba(255,255,255,0.92),rgba(253,244,240,0.78))] p-6 shadow-[0_18px_45px_rgba(173,131,145,0.16)] backdrop-blur-[2px] lg:col-span-5 lg:row-span-3 lg:p-8">
        <div>
          ...
          <h1 className="mt-2 font-serif text-[2rem] leading-[1.03] tracking-[-0.015em] text-charcoal lg:text-[3.4rem]">Editorial Layout Mosaic</h1>
          <p className="mt-3 max-w-xl text-[0.97rem] leading-relaxed text-charcoal/62 lg:text-[1.02rem]">Magazine-inspired spatial rhythm with modular media storytelling in a refined, gallery-led composition.</p>
          <div className="mt-6">
            <Link
              href={localizeHref('/shop', locale)}
