...
export function CategoriesSection() {
  ...
  const copy = {
    ...
    journalsCta: locale === 'ar' ? 'عرض سجلات العناية' : locale === 'fr' ? 'Voir les journaux de soin' : locale === 'de' ? 'Pflegejournale ansehen' : locale === 'ko' ? '케어 저널 보기' : locale === 'tr' ? 'Bakım günlüklerini gör' : 'View Care Journals',
